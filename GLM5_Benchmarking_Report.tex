...
Table \ref{tab:category_scores} presents category-level scores; the full 26-criterion breakdown is in Table \ref{tab:full_rubric}. The weighted mean was 4.23 / 5.00 (84.6\%).
...
\midrule
\textbf{Overall Weighted Mean} & \textbf{4.23} \\
\bottomrule
\end{tabular}
\end{table}
